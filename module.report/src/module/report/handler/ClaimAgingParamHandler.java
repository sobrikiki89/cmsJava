...
public class ClaimAgingParamHandler extends ReportParamHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(ClaimAgingParamHandler.class);

	public ClaimAgingParamHandler() {
		super();
	}
