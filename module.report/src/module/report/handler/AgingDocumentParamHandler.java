...
public class AgingDocumentParamHandler extends ReportParamHandler {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(AgingDocumentParamHandler.class);
	
	SimpleDateFormat sdfD = new SimpleDateFormat("dd-MM-yyyy");

	public AgingDocumentParamHandler() {
		super();
	}
