...
public class PremiumTabulationSummaryParamHandler extends ReportParamHandler {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(PremiumTabulationSummaryParamHandler.class);
	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
	SimpleDateFormat sdfD = new SimpleDateFormat("dd-MM-yyyy");
	
	public PremiumTabulationSummaryParamHandler() {
		super();
		// Initialization
	}
