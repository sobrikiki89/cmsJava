...
public class ClaimByClassOfInsuranceDetailParamHandler extends ReportParamHandler {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(ClaimByLossTypeParamHandler.class);
	
	SimpleDateFormat sdfD = new SimpleDateFormat("dd-MM-yyyy");

	public ClaimByClassOfInsuranceDetailParamHandler() {
		super();
	}
	...
	public String formatParams() {
		...
		if (paramMap.get("toLossDate") != null && !"".equals(paramMap.get("toLossDate")) && paramMap.get("toLossDate") instanceof String) {
