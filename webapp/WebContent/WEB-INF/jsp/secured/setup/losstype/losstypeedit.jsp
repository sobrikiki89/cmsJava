...
<spring:url var="saveUrl" value="/secured/setup/losstype/edit" />
	    ...
	    <div class="col-sm-1"></div>
	  	<div class="panel-group col-sm-10">
		    <div class="panel panel-primary">
		    	<div class="panel-heading"><spring:message code="setup.losstype.editLossType" /></div>
				...
				<div class="panel-body">
					<div class="form-group row">
  						<label class="control-label col-sm-2" for="code">
  							<spring:message code="setup.losstype.code" />
  						</label>
  						<span class="col-sm-2">
   							<form:input path="lossType.code" class="form-control input-sm" id="code" style="width:100%; text-transform: uppercase" maxlength="5" readonly="true"/>
   						</span>
					</div>
					<div class="form-group row">
