...
<spring:url var="postUrl" value="/secured/setup/adjuster/edit" />
	    ...
	    <div class="col-sm-1"></div>
	  	<div class="panel-group col-sm-10">
		    <div class="panel panel-primary">
		    	<div class="panel-heading"><spring:message code="setup.adjuster.new" /></div>
				<form:form commandName="adjusterForm" method="post" action="${postUrl}" role="form" class="form-horizontal">
				<form:errors element="div" cssClass="errorblock" path="*" />
				<div class="panel-body">
					<div class="form-group row">
						<label class="control-label col-sm-2" for="firmName">
							<spring:message code="setup.adjuster.firmName" /><span class="mandatory">*</span>
						</label>
						<span class="col-sm-9">
							<form:input path="adjusterDTO.firmName" class="form-control input-sm" id="firmName"/>
						</span>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
  						...
  						<span class="col-sm-4">
  							<form:select path="contactDTO.stateCode" class="form-control input-sm" id="state">
								...
								<form:options items="${adjusterForm.states}" itemLabel="name" itemValue="code" />
							</form:select>
   						</span>
   						...
   						<span class="col-sm-2">
							<form:checkbox path="adjusterDTO.activeFlag" />
						</span>
   					</div>	   				
					<div class="form-group row">
  						...
  						<span class="col-sm-9">
   							<form:textarea path="adjusterDTO.remark" class="form-control input-sm" rows="6" id="remark"/>
   						</span>					
					</div>
				</div>
