...
<spring:url var="postUrl" value="/secured/setup/solicitor/edit" />
	    ...
	    <div class="col-sm-1"></div>
	  	<div class="panel-group col-sm-10">
		    <div class="panel panel-primary">
		    	<div class="panel-heading"><spring:message code="setup.solicitor.edit" /></div>
				...
				<div class="panel-body">
					...
					<div class="form-group row">
  						...
  						<span class="col-sm-9">
   							<form:textarea path="solicitorDTO.remark" class="form-control input-sm" rows="6" id="remark"/>
   						</span>					
					</div>
				</div>
