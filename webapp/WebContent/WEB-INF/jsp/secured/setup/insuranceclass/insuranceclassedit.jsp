...
<spring:url var="saveUrl" value="/secured/setup/insuranceclass/edit" />
	    ...
	    <div class="col-sm-1"></div>
	  	<div class="panel-group col-sm-10">
		    <div class="panel panel-primary">
		    	<div class="panel-heading"><spring:message code="setup.insuranceclass.editInsuranceClass" /></div>
				...
				<div class="panel-body">
					<div class="form-group row">
  						<label class="control-label col-sm-2" for="code">
  							<spring:message code="setup.insuranceclass.code" />
  						</label>
  						<span class="col-sm-2">
   							<form:input path="insuranceClass.code" class="form-control input-sm" id="code" maxlength="5" 
   								style="width:100%; text-transform: uppercase" readonly="true"/>
   						</span>
  						<label class="control-label col-sm-2" for="code">
  							<spring:message code="setup.insuranceclass.category" /><span class="mandatory">*</span>
  						</label>
  						<span class="col-sm-4">
  							<form:select path="categoryCode" class="form-control input-sm" id="category" >
