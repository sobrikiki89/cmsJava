...
<spring:url var="saveUrl" value="/secured/setup/insurer/new" />
	    ...
	    <div class="col-sm-1"></div>
	  	<div class="panel-group col-sm-10">
		    <div class="panel panel-primary">
		    	<div class="panel-heading"><spring:message code="setup.insurer.newInsurer" /></div>
				...
				<div class="panel-body">
					<div class="form-group row">
  						<label class="control-label col-sm-2" for="code">
  							<spring:message code="setup.insurer.code" /><span class="mandatory">*</span>
  						</label>
  						<span class="col-sm-2">
   							<form:input path="insurer.code" class="form-control input-sm" id="code" maxlength="5"
